...
/**
 * Bridge deseni, yazılım geliştirirken soyutlama yapmış olduğumuz yapıları entegre ettiğimiz
 * yapılardan ayırmaya ve esneklik sağlamamıza yarayan bir tasarım desenidir.
 */
public class Bridge {
