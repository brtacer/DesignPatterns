...
/**
 * Abstract Factory (Soyut Fabrika) tasarım deseni, concrete1abstract olmayan sınıfları tanımlamada kullanılan terim sınıfları belirlemeden
 * ilgili nesnelerin ailelerini üretmenizi sağlayan creational kategorisindeki bir tasarım desenidir.
 */
