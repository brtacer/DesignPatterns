...
/**
 * Yirmi üç çeşit tasarım kalıbından biri olan aracı tasarım kalıbı davranışsal tasarım kalıplarının alt dallarından biri olarak kabul edilir.
 * Aracı kalıbı genel olarak nesnelerin yönetimi, aralarındaki iletişimin merkezi bir noktadan sağlanması ve yönetilmesi için kullanılır.
 * Bu nesneler arasındaki bağı azaltmakta ve sadece bir sınıfı, yönetici sınıf olarak diğer sınıfların koordine edilmesinden sorumlu kılar.
 */
