...
/**
 * Bir isteği nesneye dönüştürerek, isteğin kullanıcı sınıfları tarafından
 * rahatça erişilebilmesi sağlar.
 * Nesne üzerinde bir işleminin nasıl yapıldığını bilmediğimiz ya da
 * kullanılmak istenen nesneyi tanımadığımız durumlarda kullanılır.
